...
**Not yet implemented** — service layer (Stories 9–10), API / DTOs / middleware / router (Stories 11–16), `main.go` wiring (Story 17), Makefile + README (Stories 18–19), final rubric sweep (Story 20).
